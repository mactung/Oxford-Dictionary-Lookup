(function() {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              data && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 12, fill: saved ? "currentColor" : "none" }),
                    saved ? "Saved" : "Save"
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "hover:text-red-200 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 20 }) })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 overflow-y-auto custom-scrollbar", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-8 text-gray-400", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Loader2, { className: "animate-spin mb-2" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Loading..." })
          ] }) : error ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-red-500 text-center py-4", children: error }) : data ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2 mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-oxford-blue", children: data.headword }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 italic", children: data.pos })
            ] }),
            data.phonetics && data.phonetics.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3 mb-4", children: data.phonetics.map((p2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-oxford-light bg-blue-50 px-2 py-1 rounded-full text-sm", children: [
              p2.type && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-xs uppercase text-gray-400 mr-1", children: p2.type }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                "/",
                p2.ipa,
                "/"
              ] }),
              p2.audioUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(
                Volume2,
                {
                  size: 14,
                  className: "cursor-pointer hover:scale-110 transition-transform ml-1",
                  onClick: () => playAudio(p2.audioUrl)
                }
              )
            ] }, i)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
              data.senses && data.senses.map((sense, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-semibold text-gray-800 mb-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-oxford-blue mr-1", children: [
                    i + 1,
                    "."
                  ] }),
  ...
  function getHost() {
    ...
    if (!host) {
      ...
      reactRoot = client.createRoot(container);
    }
  ...
  const createIcon = (x2, y2, selectionText) => {
    ...
    iconElement.addEventListener("click", (e) => {
      e.preventDefault();
      e.stopPropagation();
      mountPopup(x2, y2 - 5, selectionText);
      if (iconElement) iconElement.remove();
      iconElement = null;
    });
...
`;
  ...
  function highlightSavedWords() {
    chrome.storage.local.get(["vocabulary"], (result) => {
      ...
      const wordsToHighlight = new Set(vocabulary.map((v2) => v2.headword.toLowerCase()));
